...
public class Company extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        users.add(new User("Алиса", 20, 150, false));
        users.add(new User("Боб", 34, 300, true));
        users.add(new User("Петя", 18, 100, false));
        users.add(new User("Катя", 38, 300, true));
        users.add(new User("Стив", 31, 250, true));
        users.add(new User("Алан", 62, 500, true));
        users.add(new User("Юлия", 33, 320, true));
        users.add(new User("Патрик", 37, 300, true));
        users.add(new User("Александр", 34, 280, true));
        users.add(new User("Георгий", 28, 180, true));
        users.add(new User("Мария", 22, 190, false));
